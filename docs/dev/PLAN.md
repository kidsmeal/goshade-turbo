...
- `NOW.md`, `docs/dev/PLAN.md` (orchestrator state, edited by the pipeline scripts and the orchestrator, not by the implementer)
...
- `NOW.md`, `docs/dev/PLAN.md` (orchestrator state, edited by the pipeline scripts and the orchestrator)
...
- `NOW.md`, `docs/dev/PLAN.md` (orchestrator state), `**/*.gd.uid`, `**/*.import` sidecars
...
- `NOW.md`, `docs/dev/PLAN.md` (orchestrator state), `**/*.gd.uid` sidecars
